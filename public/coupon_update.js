...
coupons = ["fitternityuw7rybqqevcred_afhjdshbsd"];
var x = db.coupons.update({"code": {"$in": coupons}}, {$set: {
    "and_conditions" : [ 
    {
        "key" : "pass.pass_type",
        "operator" : "in",
...
// var y = db.coupons.update({"code": {"$in": coupons_180}}, {$set: {
//     "and_conditions" : [ 
//         {
//             "key" : "pass.pass_type",
//             "operator" : "in",
...
// var y = db.coupons.update({"code": {"$in": coupons_360}}, {$set: {
//     "and_conditions" : [ 
//         {
//             "key" : "pass.pass_type",
//             "operator" : "in",
