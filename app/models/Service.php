						...
						if(isset($value['flags']['offerFor'])){
							...
							switch($value['flags']['offerFor']){
								case "student": 
												...
												$ratecardoffers[0]['offer_icon']    =   "https://b.fitn.in/global/trial-ratecard-monsoon.png";	
												break;
								case "women": 
												// $ratecardoffers[0]['offer_text']    =   "";
												$ratecardoffers[0]['offer_icon']    =   "https://b.fitn.in/global/trial-ratecard-monsoon.png";	
...
//                var_dump($ratecardoffers);exit;
			...
			// 			$value['offers'][0]['offer_icon'] = 'https://b.fitn.in/global/trial-ratecard-monsoon.png';
			// 		}
			// 	}
			// }
