						...
						if(isset($value['flags']['offerFor'])){
							...
							switch($value['flags']['offerFor']){
								case "student": 
												...
												$ratecardoffers[0]['offer_icon']    =   "https://b.fitn.in/global/try-again-monsoon-sale.png";	
												break;
								case "women": 
												// $ratecardoffers[0]['offer_text']    =   "";
												$ratecardoffers[0]['offer_icon']    =   "https://b.fitn.in/global/try-again-monsoon-sale.png";	
...
//                var_dump($ratecardoffers);exit;
			...
			// 			$value['offers'][0]['offer_icon'] = 'https://b.fitn.in/global/try-again-monsoon-sale.png';
			// 		}
			// 	}
			// }
