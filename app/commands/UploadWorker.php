...
class UploadWorker extends Command
{
    ...
    protected $workers_dir = 'app/workers';
    ...
    protected function getOptions()
    {
        return array(
            ...
            array('push_queue_type', null, InputOption::VALUE_OPTIONAL, 'Type of the push queue.', 'multicast'),
            array('max_concurrency', null, InputOption::VALUE_OPTIONAL, 'Max concurrency.', null),
            array('update_queue', true, InputOption::VALUE_OPTIONAL, 'Update the queue', true),
        );
    }
