...
class PassService {
    ...
    public function passCapture($data, $existing_order = null){
        ...
        if(!empty($data['customer_source']) && (in_array($data['customer_source'], ['sodexo', 'thelabellife', 'generic']) || (!empty($data['corporate_source']) && in_array($data['corporate_source'], ['generic'])))){
