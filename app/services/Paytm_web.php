...
Class Paytm_web {
    protected $PAYTM_ENVIRONMENT;
    protected $PAYTM_MERCHANT_KEY;
    protected $PAYTM_MERCHANT_MID;
    protected $PAYTM_MERCHANT_WEBSITE;
    protected $PAYTM_REFUND_URL;
    protected $PAYTM_STATUS_QUERY_URL;
    protected $PAYTM_STATUS_QUERY_NEW_URL;
    protected $PAYTM_TXN_URL;
    public function __construct() {
        $this->PAYTM_ENVIRONMENT='TEST'; // PROD
