    ...
    public function getPassBranding($args = null){
        ...
        switch($city_name){
            case "mumbai":
                ...
                $return_arr['black_remarks_header'] = "FLAT 20% Off On OnePass Membership + Assured Gift\n\nUse Code: XMAS20, Limited Slots\n\n21-27 Dec";
                $return_arr['red_remarks_header'] = "EXTRA 20% Off  OnePass Membership + Assured Gift \n\nUse Code: XMAS20, Limited Slots\n\n21-27 Dec";
