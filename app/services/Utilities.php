    ...
    public function getPassBranding($args = null){
        ...
        switch($city_name){
            case "mumbai":
                if(!empty($pass)){
                    ...
                    if(!empty($pass['pass_type']) && $pass['pass_type'] == 'red'){
                        ...
                        $return_arr['text'] = "FLAT 15% off + \nSpecial Edition Virat Kohli-Puma Gym Bag Worth INR 1500 (Use Code: VK15)";
                    ...
                    if(!empty($pass['pass_type']) && $pass['pass_type'] == 'black'){
                        if(!empty($pass['duration']) && in_array($pass['duration'],[30, 45])){
                            $return_arr['text'] = "Special Edition Virat Kohli-Puma Gym Bag Worth INR 1500";
                            $return_arr['purchase_summary_value'] = "Get Special Edition Virat Kohli-Puma Gym Bag Worth INR 1500 | 21-23 Nov";
            ...
            case "bangalore":
                ...
                $return_arr['black_remarks_header'] = "\n\nFlash Sale: FLAT 35% Off + Special Edition Virat Kohli-Puma Gym Bag Worth INR 1500 \nBuy Now To Save More! Start At Your Convenience \n21-23 Nov";
                $return_arr['red_remarks_header'] = "\n\nFlash Sale: FLAT 35% Off + Special Edition Virat Kohli-Puma Gym Bag Worth INR 1500 \nBuy Now To Save More! Start At Your Convenience \n21-23 Nov";
            ...
            case "faridabad":
                ...
                $return_arr['black_remarks_header'] = "\n\nFlash Sale: FLAT 50% Off + Special Edition Virat Kohli-Puma Gym Bag Worth INR 1500 \nBuy Now To Save More! Start At Your Convenience \n21-23 Nov";
                $return_arr['red_remarks_header'] = "\n\nFlash Sale: FLAT 50% Off + Special Edition Virat Kohli-Puma Gym Bag Worth INR 1500 \nBuy Now To Save More! Start At Your Convenience \n21-23 Nov";
