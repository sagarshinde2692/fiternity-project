...
if (!function_exists('get_elastic_service_document')) {
    ...
    function get_elastic_service_document($servicedata = array()) {
        ...
        $postfields_data = array(
            ...
            'finername'                     =>      (isset($data['finder']['title']) && $data['finder']['title'] != '') ? strtolower($data['finder']['title']) : "", 
            'finername_snow'                =>      (isset($data['finder']['title']) && $data['finder']['title'] != '') ? strtolower($data['finder']['title']) : "", 
            'finerslug'                     =>      (isset($data['finder']['slug']) && $data['finder']['slug'] != '') ? strtolower($data['finder']['slug']) : "", 
            'finerslug_snow'                =>      (isset($data['finder']['slug']) && $data['finder']['slug'] != '') ? strtolower($data['finder']['slug']) : "", 
