                                            ...
                                            <tbody>
                                                ...
                                                <tr style="background-color:#f6f6f6;">
                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:left;line-height: 23px; color: #626262; padding:20px 0px;" st-content="fulltext-paragraph">
                                                        ...
                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; line-height: 23px; padding: 20px; " st-content="fulltext-paragraph"> Greetings from Fitternity!<br /><br />Thank you for being part of FitMania 2016. <br />

                                                            We closed the sale on a great note closing 10,000+ sales across all cities. This wouldn't have been possible without your continued support. <br />

                                                            Kindly note a brief summary of all the sales through FitMania:
                                                        </p>
                                                ...
                                                <tr style="background-color:#f6f6f6;">
                                                    <td>
                                                        <hr style="width:30%;" />    
                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;line-height: 23px; padding-top:30px; padding-bottom:20px; " st-content="fulltext-paragraph"><strong style="color:#f9a91e;">{{$finder_name}} <?php if(isset($finder_location) && $finder_location != ""){ ?>- {{ ucwords($finder_location) }}<?PHP } ?></strong></p>  
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;color: #464646;; padding-left:20px; " st-content="fulltext-paragraph">
                                                                        ...
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; font-size: 15px; text-align:left;line-height: 18px; " st-content="fulltext-paragraph">{{ intval($key) + 1 }}. {{$order['customer_name']}}</p>
                                                                        <?PHP  }?>

                                                                        <?php if(isset($order['customer_phone']) && $order['customer_phone'] != ""){ ?>
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-weight:bold;font-size: 15px; text-align:left;line-height: 18px; padding-top:5px;" st-content="fulltext-paragraph"> &nbsp;&nbsp;&nbsp; {{$order['customer_phone']}}</p> 
                                                                        <?PHP  }?>

                                                                        <?php if(isset($order['customer_email']) && $order['customer_email'] != ""){ ?>
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-weight:bold;font-size: 15px; text-align:left;line-height: 18px; padding-top:5px; padding-bottom:10px;" st-content="fulltext-paragraph">&nbsp;&nbsp;&nbsp; {{$order['customer_email']}}</p>
                                                                        <?PHP  }?>
                                                        ...
                                                        <table width="300px;" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                            <tbody>
                                                                <tr>
                                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;color: #464646;; padding-left:20px; " st-content="fulltext-paragraph">
                                                                        <?php if(isset($order['preferred_starting_date']) && $order['preferred_starting_date'] != ""  &&  $order['preferred_starting_date'] != "-"){ ?>
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; font-size: 15px; text-align:left;line-height: 23px; " st-content="fulltext-paragraph">&nbsp;&nbsp;&nbsp; Starting date:</p>
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 15px; " st-content="fulltext-paragraph">&nbsp;&nbsp;&nbsp; {{date('jS F Y',strtotime($order['preferred_starting_date']))}}</p>
                                                                        <?PHP } ?>

                                                                        <?php if(isset($order['service_name']) && $order['service_name'] != ""){ ?>
                                                                        ...
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 15px; " st-content="fulltext-paragraph">&nbsp;&nbsp;&nbsp; {{ ucwords($order['service_name']) }} </p>                                                                           
                                                                        <?PHP } ?>


                                                                          <?php if(isset($order['service_duration']) && $order['service_duration'] != ""){ ?>
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-weight:bold;font-size: 15px; text-align:left;line-height: 23px; padding-top:10px;" st-content="fulltext-paragraph">&nbsp;&nbsp;&nbsp; Duration:</p> 
                                                ...
                                                <tr style="background-color:#f6f6f6;"> <td>  <hr style="width:90%;" /> </td>  </tr>
                                                ...
                                                <tr style="background-color:#f6f6f6;">
                                                    <td width="100%" align="center" class="devicewidth">
                                                        <img src="http://email.fitternity.com/202/fitmaniainfo.jpg" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none; ">
                                                    </td>
                                                </tr>                                    
