                ...
                <tr>
                  <td>
                    <table width="580" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                      <tbody>
                        ...
                        <tr style="background-color:#f6f6f6;">
                          <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;line-height: 23px; color: #626262; padding:20px;" st-content="fulltext-paragraph">
                            ...
                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding: 20px; " st-content="fulltext-paragraph"> We have processed a membership sale  for  <strong>{{$finder_name}} <?php if(isset($finder_location) && $finder_location != ""){ ?>, {{ ucwords($finder_location) }}<?PHP } ?> </strong>offer on Women's Day powered by Fitternity.com</p>
                     ...
                     <tr style="background-color:#f6f6f6;">
                      <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;line-height: 23px; color: #626262; padding:20px;" st-content="fulltext-paragraph"> 
                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding: 20px; " st-content="fulltext-paragraph"> Please call us in case of any queries - you can reach your assigned Relationship Manager directly or call us on {{Config::get('app.contact_us_vendor_number')}}.</p>
