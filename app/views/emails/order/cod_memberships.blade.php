                    ...
                    <td align="center">
                        <table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" modulebg="edit">
                            <tbody>
                                ...
                                <tr style="background-color:#f6f6f6;">
                                    <td>
                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;line-height: 23px; padding-top:20px; padding-bottom:20px;" st-content="fulltext-paragraph"><strong style="color:#f9a91e;">Your request details</strong></p>
                                                ...
                                                <tr>
                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;color: #464646;; padding:20px; " st-content="fulltext-paragraph">
                                                        ...
                                                        <?php if(isset($customer_name) && $customer_name != ""){ ?>
                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 25px; " st-content="fulltext-paragraph"> <strong>Membership Requested for:</strong>{{ ucwords($customer_name) }}</p>
                                                        <?php }?>
                                                        ...
                                                        <?php if(isset($service_name) && $service_name != ""){ ?>
                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px;   " st-content="fulltext-paragraph"> <strong>Workout form: </strong>{{ucwords($service_name)}}</p>
                                                        <?php }?>
