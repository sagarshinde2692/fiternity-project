              ...
              <tr>
                <td style="font-family:Arial, Helvetica, sans-serif; font-size: 16px; text-align:left;line-height: 35px; padding:5px 10px;" st-content="fulltext-paragraph">
                 ...
                 <p style="padding-top:30px; font-weight:bold; color:#5f5e5e; font-size:20px;"><span style="color:#5f5e5e; font-weight:400;" href="mailto:info@fitternity.com">
                  ...
                  <p style="padding-top:25px; line-height:20px; font-weight:lighter; color:#5f5e5e">Greetings from Fitternity.com!.</p> 

                  <?php if(isset($email_body1) && $email_body1 != ""){ ?>
                  <p style="padding-top:25px; line-height:20px; font-weight:lighter; color:#5f5e5e">{{ $email_body1 }} </p>
                  <?php }?>

                  <p style="padding-top:25px; line-height:20px; font-weight:lighter; color:#5f5e5e">The details of your purchase are as mentioned below : </p>

                  <p style="padding-top:25px; line-height:20px; font-weight:lighter; color:#5f5e5e">Subscription No: <?php if(isset($_id) && $_id != ""){ ?>{{ $_id }}<?php }?></p> 

                  <?php if(isset($customer_name) && $customer_name != ""){ ?><p style="padding-top:25px; line-height:20px; font-weight:lighter; color:#5f5e5e">Name: {{ $customer_name }} </p> <?php }?>
                    <?php if(isset($customer_email) && $customer_email != ""){ ?><p style="padding-top:25px; line-height:20px; font-weight:lighter; color:#5f5e5e">Email: {{ $customer_email }} </p> <?php }?>
                      <?php if(isset($customer_phone) && $customer_phone != ""){ ?><p style="padding-top:25px; line-height:20px; font-weight:lighter; color:#5f5e5e">Contact: {{ $customer_phone }}</p> <?php }?>
                        ...
                        <p style="padding-top:25px; line-height:20px; font-weight:lighter; color:#5f5e5e">{{ $email_body2 }} </p>
                        <?php }?>
