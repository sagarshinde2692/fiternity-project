                                ...
                                <tr>
                                    <td>
                                        <table width="580" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;color: #464646;; padding-left:20px; " st-content="fulltext-paragraph">
                                                                        ...
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 15px; " st-content="fulltext-paragraph">{{$order['customer_name']}}</p>
                                                                        <?PHP  }?>
                                                                        ...
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 15px; " st-content="fulltext-paragraph">{{$order['customer_phone']}}</p>
                                                                        <?PHP  }?>
                                                                        ...
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 15px; " st-content="fulltext-paragraph">Rs. {{$order['amount']}}</p>
                                                                        <?PHP  }?>

                                                                        <?php if(isset($order['batches']) && $order['batches'] != "-" && $order['batches'] != ""){ ?>
                                                                        ...
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 15px; " st-content="fulltext-paragraph"> 
                                                                            @foreach($order['batches'] as $key => $value)
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;color: #464646;; padding-left:20px; " st-content="fulltext-paragraph">
                                                                    ...
                                                                    <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 15px; " st-content="fulltext-paragraph">{{$order['service_name']}}</p>                                                                           
                                                                    <?PHP } ?>
                                            ...
                                            <tr style="background-color:#f6f6f6;">
                                                <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;line-height: 23px; color: #626262; padding:20px;" st-content="fulltext-paragraph"> 
                                                    <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding: 20px; " st-content="fulltext-paragraph"> In case of any questions please reach out to us on {{Config::get('app.customer_care_number')}}.</p>
