              ...
              <tr>
                <td style="font-family:Arial, Helvetica, sans-serif; font-size: 16px; text-align:left;line-height: 35px; padding:5px 10px;" st-content="fulltext-paragraph">
                 ...
                 <p style="padding-top:30px; font-weight:bold; color:#5f5e5e; font-size:20px;"><span style="color:#5f5e5e; font-weight:400;" href="mailto:{{Config::get('app.contact_us_customer_email')}}">
                  ...
                  <p style="padding-top:25px; line-height:20px; font-weight:lighter; color:#5f5e5e">Congratulations, you are now a member of the Arsenal Mumbai Supporters Club 2015-16. We have received your payment for the same. With your membership comes wide range of club merchandise, exclusive screening of the matches and much more.  The details of your purchase are as mentioned below : </p>
