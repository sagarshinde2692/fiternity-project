                    ...
                    <td align="center">
                        <table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" modulebg="edit">
                            <tbody>
                                ...
                                <tr style="background-color:#f6f6f6;">
                                    <td>
                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;line-height: 23px; padding-top:20px; padding-bottom:20px;" st-content="fulltext-paragraph"><strong style="color:#f9a91e;">Here are the details</strong></p>
                                                ...
                                                <tr>
                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;color: #464646;; padding:20px; " st-content="fulltext-paragraph">
                                                        ...
                                                        <?php if(isset($service_duration) && $service_duration != ""){ ?>
                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px;  " st-content="fulltext-paragraph"> <strong>Duration:</strong>{{$service_duration}}</p>
                                                        <?php }?>
                                                        ...
                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px; padding-bottom:5px" st-content="fulltext-paragraph"> <strong>Mode of Payment:</strong> Online</p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
