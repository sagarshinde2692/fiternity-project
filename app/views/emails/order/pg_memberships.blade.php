                        ...
                        <table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" modulebg="edit">
                                            ...
                                            <tbody>
                                                ...
                                                <tr style="background-color:#f6f6f6;">
                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:left;line-height: 23px; color: #626262; padding:20px;" st-content="fulltext-paragraph">
                                                        ...
                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px; padding-top:10px; " st-content="fulltext-paragraph">Thank you for requesting purchase of {{  ucwords($service_name) }} - {{ ucwords($service_duration) }} at {{  ucwords($finder_name) }}. </p>
                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px; padding-top:10px; " st-content="fulltext-paragraph"><span style="color:#ec8601; font-weight:100;" href="mailto:info@fitternity.com">Prefered Starting Date:</span> {{ date(' jS F\, Y \(l\) ', strtotime($preferred_starting_date) ) }}
                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px; padding-top:10px; " st-content="fulltext-paragraph">Our team will reach out to you to get the cash pick up details. Once the cash has been collected, you will receive a purchase confirmation.</p>
                            ...
                            <tr style="background-color:#f6f6f6;">
                                <td style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px; color: #464646; padding:20px; font-weight:light" st-content="fulltext-paragraph">
                                    <p>If you have any queries please call us at <span style="color:#ec8601; font-weight:400;" href="mailto:info@fitternity.com">{{Config::get('app.customer_care_number')}}</span>  or email us on<a style="text-decoration:none; color:#ec8601" href="mailto:info@fitternity.com"> info@fitternity.com</a></p>
