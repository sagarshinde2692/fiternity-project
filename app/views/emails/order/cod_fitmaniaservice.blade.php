...
Hi {{  ucwords($customer_name) }}!</span></p>      
              ...
              <p style="padding-top:15px; line-height:20px; font-weight:lighter; color:#5f5e5e">Thank you for your request to purchase {{  ucwords($service_name) }} - {{ ucwords($service_duration) }} at {{  ucwords($finder_name) }}. 

<p style="padding-top:5px; line-height:20px; font-weight:lighter; color:#5f5e5e">Our team will reach out to you to get the cash pick up details. Once the cash has been collected, you will receive a purchase confirmation through which you can get your membership started. </p>
