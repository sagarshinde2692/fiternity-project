...
<body style="background-image:url(http://email.fitternity.com/197/pattern.jpg)">
    <div class="block">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="3columns" style="table-layout:fixed;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr style="background-color:#f6f6f6;">
                                                    <td width="100%" align="center" class="devicewidth">
                                                        ...
                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 18px; text-align:center;line-height: 24px; padding: 5px;  " st-content="fulltext-paragraph">Please reach out to us for queries on - {{Config::get('app.customer_care_number')}}</p>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr style="background-color:#f6f6f6;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;color: #464646;; padding-left:20px; " st-content="fulltext-paragraph">
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding:20px; vertical-align:central; " st-content="fulltext-paragraph">
                                                                            <img width="80px;" src="http://email.fitternity.com/197/refer.png" /></p>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                            <table width="350px;" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;color: #464646;; padding-left:20px; " st-content="fulltext-paragraph">
                                                                            <?php if(isset($order['_id']) && $order['_id'] != ""){ ?> 
                                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px;  " st-content="fulltext-paragraph"> <strong>Subscription number:</strong> {{ $order['_id'] }}</p>
                                                                            <?php }?>

                                                                            <?php if(isset($order['finder_name']) && $order['finder_name'] != ""){ ?>  
                                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px; " st-content="fulltext-paragraph"> <strong>Fitness Destination: </strong> {{ ucwords($order['finder_name']) }}<?php if(isset($order['finder_location']) && $order['finder_location'] != ""){ ?>, {{ ucwords($order['finder_location']) }}<?PHP } ?></p>
                                                                            <?PHP } ?>

                                                                            <?php if(isset($order['service_name']) && $order['service_name'] != ""){ ?>
                                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px;  " st-content="fulltext-paragraph"> <strong>Membership Type:</strong> {{ ucwords($order['service_name']) }}</p>
                                                                            <?PHP } ?>

                                                                            <?php if(isset($order['service_duration']) && $order['service_duration'] != ""){ ?>
                                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px;  " st-content="fulltext-paragraph"> <strong>Duration:</strong> {{ ucwords($order['service_duration']) }}</p>
                                                                            <?PHP } ?>

                                                                            <?php if(isset($order['preferred_starting_date']) && $order['preferred_starting_date'] != ""  &&  $order['preferred_starting_date'] != "-"){ ?>
                                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px;  " st-content="fulltext-paragraph"> <strong>Starting Date: </strong>{{ date(' jS F\, Y \(l\) ', strtotime($order['preferred_starting_date']) )  }}</p>
                                                                            <?PHP } ?>
                                                    ...
                                                    <tr style="background-color:#f6f6f6;">
                                                        <td>
                                                            ...
                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;line-height: 23px; padding-top:20px; padding-bottom:20px; " st-content="fulltext-paragraph"><strong style="color:#f9a91e;">Call us for help</strong></p>
                                                            <!-- col 1 -->
                                                            <table width="200px;" border="0" align="left" cellpadding="0" cellspacing="0" class="devicewidth">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;color: #464646;; padding-left:20px; " st-content="fulltext-paragraph">
                                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding:20px; vertical-align:central; " st-content="fulltext-paragraph">
                                                                                <img width="70px;" src="http://email.fitternity.com/197/call.png" /></p>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                        ...
                                                        <tr style="background-color:#f6f6f6;">
                                                            <td width="100%" align="center" class="devicewidth">
                                                                <hr style="color:#535353;" width="80%;">
                                                                <a href="http://www.fitternity.com" target="_blank"><img  src="http://email.fitternity.com/197/fitmania.jpg" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none; "></a>
                                                                <a href="http://www.fitternity.com" target="_blank"><img  src="http://email.fitternity.com/197/fitmania2.jpg" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none; "></a>
            ...
            <div class="block">
                <table bgcolor="#e9e9e9" width="580px" cellpadding="0" align="center" cellspacing="0" border="0" st-sortable="postfooter" class="devicewidth" style="table-layout:fixed; ">
                    <tbody>

                        <tr style="background-color:#f6f6f6;">
                            <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;line-height: 23px; padding:20px;" st-content="fulltext-paragraph">
                                <p>But wait there is more!
                                    <br />We have collaborated with some of the best brands to offer you awesome deals!</p>
                                    <hr width="100px">
                                    <table width="180px;" border="0" align="left" cellpadding="0" cellspacing="0" class="devicewidth">
                                        ...
                                        <table width="180px;" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                            <tbody>
                                                <tr>
                                                    <td width="100%" align="center" class="devicewidth">
                                                        <a href="http://www.myglamm.com/" target="_blank"><img width="100%" src="http://email.fitternity.com/199/myglamm1.jpg" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;"></a>
