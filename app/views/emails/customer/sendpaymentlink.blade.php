            ...
            <tbody>
              ...
              <tr>
                <td style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 18px; padding:5px 5px; color:#666" st-content="fulltext-paragraph">
                  <p>Hey {{ ucwords($customer_name) }}, <br></p>
                  <p style="padding-top:25px">Thank you for purchasing your fitness membership on Fitternity.com! </p>
                  <p>We are very excited to get you started at {{ ucwords($finder_name) }} @if ($show_location_flag) ,  {{ ucwords($finder_location) }} @endif  - we truly hope it is a great experience for you.</p>
            ...
            <tbody>
              ...
              <tr>
                <td style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 18px; padding:5px 5px; color:#666" st-content="fulltext-paragraph">
                  ...
                  <p style="padding-top:20px; font-size:15px;">Regards </p>
                  <p style="padding-top:20px; font-size:15px;">TEAM FITTERNITY<br />
