                                                ...
                                                <tr style="background-color:#f6f6f6;">
                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;line-height: 23px; color: #626262; padding:20px;" st-content="fulltext-paragraph">
                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding-top:20px; padding-bottom:10px; " st-content="fulltext-paragraph">
                                                            <p>Hey {{  ucwords($customer_name) }},</p>

                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding-top:10px; " st-content="fulltext-paragraph">Thank you for purchasing your fitness membership on Fitternity</p>

                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding:20px 0px; " st-content="fulltext-paragraph">We are very excited to get you started at {{ ucwords($finder_name) }} @if ($show_location_flag) ,  {{ ucwords($finder_location) }} @endif  - we truly hope it is a great experience for you.</p>

                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding:20px 0px; " st-content="fulltext-paragraph">Please access this link to make a payment: <a href="http://fitternity.com/paymentlink/{{ $order_id }}" target="_blank" style="text-decoration:underline; color:#999;"> Payment link</a></p>

                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding-top:10px; " st-content="fulltext-paragraph">Do note that this is a unique link and will expire on clicking.</p>

                                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding-top:10px; " st-content="fulltext-paragraph">If you have any questions or need any support please reply to this mail or call us on {{Config::get('app.customer_care_number')}}.</p>
