...
<title>Acknowledgement Mail (for COD – automated – triggered on lead magnet submit)</title>
<style type="text/css">
	...
	<div class="block"><!-- Start Editor's Note -->
		...
		<table width="100%" bgcolor="#fff" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="fulltext"  style="table-layout:fixed;">
			<tbody>
				<tr>
					<td align="center">
						<table style=" background:url(http://email.fitternity.com/137/bg3.png); background-repeat:no-repeat" width="580" height="315" cellpadding="0" cellspacing="0" border="0" bordercolor="#f9a91e" align="center" class="devicewidth" modulebg="edit">
							<tbody>
												...
												<tr>
													<td width="100%" style="font-family:Arial, Helvetica, sans-serif; font-size: 13px; text-align:left;line-height: 20px; padding:5px 10px;" st-content="fulltext-paragraph">
														...
														<p style="padding-top:10px; font-weight:bold;">
															...
															<p style="padding-top:10px; ">We have received your payment towards the FitCard.</p>
															<p style="padding-top:10px; padding-bottom:15px; line-height:20px; font-weight:lighter">Thank you for getting the FitCard! We are very excited to welcome to you to the
																...
																<p style="padding-top:10px; padding-bottom:15px; line-height:20px; font-weight:lighter">You now have access to variety of fitness options between Andheri to Bandra. 
																	...
																	<p style="padding-top:10px; ">Your Fitcard number is – <span style="color:#f9a91e; font-weight:bold;">5643</p>
																	<p style="padding-top:10px; ">To book sessions and access your schedule you need to go to the dashboard: 

																		<a style="text-decoration:none; color:#f9a91e;" href="#">www.fitternity.com/fitcard/dashboard</a></p>
																		<p style="padding-top:10px; padding-bottom:10px; ">You have accessed your Fitternity account through Facebook. Kindly use the 

																			same mode to log into your Dashboard.
																			<br />
																			(or)
																			<br />
																			You have accessed your Fitternity account through email. Your username is <a style="text-decoration:none; color:#f9a91e;" href="#">

																			neha@fitternity.com</a>. Kindly use the same mode to log into your Dashboard.</p>
																			<hr />
