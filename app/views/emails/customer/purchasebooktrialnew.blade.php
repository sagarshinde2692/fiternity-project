                                            ...
                                            <tbody>
                                                ...
                                                <tr style="background-color:#f6f6f6;">
                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px; color: #626262; padding:20px;" st-content="fulltext-paragraph">
                                                        ...
                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 13px; text-align:left;line-height: 23px; padding-top:10px;" st-content="fulltext-paragraph">
                                                            <li><strong>Name of Studio/Gym:</strong>  {{ ucwords($finder_name) }}</li>
                                                            <?php if(isset($service_name_purchase) && $service_name_purchase != ""){ ?>  <li><strong>Membership Details:</strong>   {{ ucwords($service_name_purchase) }}</li><?PHP } ?>
                                                                 <?php if(isset($finder_branch) && $finder_branch != ""){ ?><li><strong>Branch:</strong> {{ ucwords($finder_branch) }}</li><?PHP } ?>
                                                                <li><strong>Address:</strong> {{ ucwords($finder_address) }}</li>
                                                                <?php if(isset($service_duration_purchase) && $service_duration_purchase != ""){ ?> <li><strong>Duration:</strong>  {{ ucwords($service_duration_purchase) }}</li><?PHP } ?>
                                                                <?php if(isset($start_date) && $start_date != ""){ ?>  <li><strong>Starting Date:</strong>   {{ date(' jS F\, Y \(l\) ', strtotime($start_date) )  }}</li> <?PHP } ?>

                                                                <?php if(isset($start_date_starttime) && $start_date_starttime != ""){ ?>  <li><strong>Starting time:</strong> {{ date(' g\.i A', strtotime($start_date_starttime) ) }}</li> <?PHP } ?>
                                                                <li><strong>Subscription Code:</strong>  {{ $code }} </li>
                                                                <li><strong>Amount:</strong>  Rs. {{ $amount }}</li>
                                                                <!-- <li><strong>Mode of payment:</strong>  COD</li>  </p> -->
                                                                <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px; padding-top:10px" st-content="fulltext-paragraph">Further, do like us on <a style="color:#F9a91e;" href="https://www.facebook.com/fitternity?utm_source=Test+Users&amp;utm_campaign=cabe466217-Newsletter_20_june_146_20_2014&amp;utm_medium=email&amp;utm_term=0_c2c1b21204-cabe466217-" target="_blank">Facebook</a>, follow us on
                                                                    <a style="color:#F9a91e;" href="https://twitter.com/FitternityIndia?utm_source=Test+Users&amp;utm_campaign=cabe466217-Newsletter_20_june_146_20_2014&amp;utm_medium=email&amp;utm_term=0_c2c1b21204-cabe466217-" target="_blank">Twitter</a> and <a style="color:#F9a91e;" href="http://www.instagram.com/fitternity" target="_blank">Instagram</a>  to stay abreast with latest fitness trends & offers.</p>
                                                                    <p style="font-family:Arial, Helvetica, sans-serif; font-size: 11px; text-align:left;line-height: 23px;" st-content="fulltext-paragraph">
                                                                        *Note: Re-scheduling a particular session more than once, may attract a chargeable trial fee.</p>
                                                                    </td>
                                                                </tr>
                                                                <tr style="background-color:#f6f6f6;">
                                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px; color: #464646; padding:20px; font-weight:light" st-content="fulltext-paragraph">
                                                                        <p>Should you feel the need to change either the time or day of the session, kindly reply to this mail or call us on {{Config::get('app.contact_us_customer_number')}}.</p>
