...
<title>Welcome Mail (for PG – Automated – triggered on payment success)</title>
<style type="text/css">
										...
										<td align="center"><table width="580" cellspacing="0" cellpadding="15" align="center" class="devicewidth">
											<tbody>
												<tr style="background-color:#d9d9d9;">
													...
													<td align="center" style="color:#222222; font-family:Arial, sans serif; font-size:13px;" width="200">Call - {{Config::get('app.contact_us_customer_number')}}/td>
