...
<body>
	...
	<div style="text-align:left;">
		...
		<p>If you need to change the time or day of the session just reply to this mail or call us on {{Config::get('app.{{Config::get('app.contact_us_customer_number')}}')}}.</p>
