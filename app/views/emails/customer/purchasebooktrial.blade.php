                        ...
                        <table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" modulebg="edit">
                            <tbody>
                                            ...
                                            <tbody>
                                                ...
                                                <tr style="background-color:#f6f6f6;">
                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:left;line-height: 23px; color: #626262; padding:20px;" st-content="fulltext-paragraph">
                                                        ...
                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px; padding-top:10px; " st-content="fulltext-paragraph">Thank you for purchasing your fitness membership on Fitternity.com! We are very excited to have to started {{ ucwords($finder_name) }} @if ($show_location_flag) ,  {{ ucwords($finder_location) }} @endif - we truly hope its a great experience for you.</p>
                                ...
                                <tr style="background-color:#f6f6f6;">
                                    <td>
                                        <hr style="width:30%;" />    
                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;line-height: 23px; padding-top:30px; padding-bottom:20px; " st-content="fulltext-paragraph"><strong style="color:#f9a91e;">Details about your subscription</strong></p>  
                                        <!-- col 1 -->
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;color: #464646;; padding-left:20px; " st-content="fulltext-paragraph">
                                                     ...
                                                     <p style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; font-size: 15px; text-align:left;line-height: 23px; " st-content="fulltext-paragraph">Name of gym/studio:</p>
                                                     ...
                                                     <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 15px; " st-content="fulltext-paragraph"> {{ amount }}</p>
                                                     <?php }?>
                                                    ...
                                                    <?php if(isset($start_date) && $start_date != ""){ ?> 
                                                     ...
                                                     <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 18px; " st-content="fulltext-paragraph">{{ date(' jS F\, Y \(l\) ', strtotime($start_date) )  }}</p>
                                                     <?php }?>
                                                 </td>
                                             </tr>
                                         </tbody>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;color: #464646;; padding-left:20px; " st-content="fulltext-paragraph">
                                                     ...
                                                     <?php if(isset($service_name_purchase) && $service_name_purchase != ""){ ?> 
                                                     <p style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; font-size: 15px; text-align:left;line-height: 23px; " st-content="fulltext-paragraph">Membership Details:</p>
                                                     <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 15px; " st-content="fulltext-paragraph">{{ ucwords($service_name_purchase)  }}</p>
                                                     <?php }?>
                                                     ...
                                                     <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 15px; " st-content="fulltext-paragraph">{{ $code  }}</p>
                                                     <?php }?>

                                                     <?php if(isset($finder_address) && $finder_address != ""){ ?> 
                                                     <p style="font-family:Arial, Helvetica, sans-serif; font-weight:bold;font-size: 15px; text-align:left;line-height: 23px; padding-top:10px;" st-content="fulltext-paragraph"> Address:</p>
                                                     <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 18px; padding-bottom:30px; " st-content="fulltext-paragraph">{{ $finder_address }} </p>  
                                                     <?php }?>

                                                     <?php if(isset($finder_branch) && $finder_branch != ""){ ?> 
                                                     ...
                                                     <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 18px; padding-bottom:30px; " st-content="fulltext-paragraph">{{ $finder_branch }} </p>
                                                     <?php }?>
