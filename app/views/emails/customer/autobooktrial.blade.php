													...
													<tr>
														<td style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 18px; padding:5px 5px; color:#666" st-content="fulltext-paragraph">
															<p>Hey {{ ucwords($customer_name) }}, <br>
																<p style="padding-top:8px"> Thank you for booking a workout session / trial at {{ ucwords($finder_name) }} @if ($show_location_flag) ,  {{ ucwords($finder_location) }} @endif through Fitternity.com. Your session is CONFIRMED.   </p>  
