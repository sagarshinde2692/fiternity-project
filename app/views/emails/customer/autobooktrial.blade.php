...
<?php 
    ...
    $trial_type = (isset($type) && $type != '' && $type == 'memberships') ? 'workout' : 'trial';
    $pt = (isset($finder_category_id) && $finder_category_id == 41) ? 'with' : 'at' ;
                                                                    ...
                                                                    <table border="0" cellpadding="10" cellspacing="0" width="100%">
                                                                        <tr>
                                                                            <td valign="top" class="leftColumnContent">
                                                                                <a style="text-decoration:none; color:#ffffff;" href="http://fitternity.com/profile/{{$customer_email}}/t{{$booktrialid}}" target="_blank">
