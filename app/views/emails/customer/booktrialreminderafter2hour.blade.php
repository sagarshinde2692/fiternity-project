                                            ...
                                            <tbody>
                                                ...
                                                <tr style="background-color:#f6f6f6;">
                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;line-height: 23px; color: #626262; padding:20px;" st-content="fulltext-paragraph">
                                                        ...
                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding-top:10px; " st-content="fulltext-paragraph">Hope you had a chance to attend the <strong>{{ ucwords($finder_name) }}</strong> at <strong> @if ($show_location_flag) , {{ ucwords($finder_location) }} @endif</strong> on <strong> {{ date(' F jS\, Y \(l\) g\.i A', strtotime($schedule_date_time) )  }}.</strong></p>
...
<p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding-top:40px; padding-bottom:10px; " st-content="fulltext-paragraph">
                                   ...
                                   <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 23px; padding:5px 0px; " st-content="fulltext-paragraph"> <span style="font-weight:bold; color: #666666;" >Haven’t attended the session? Don’t fret, we’ve got you covered. <br />
<span style="color:#f9a91e;">Click here </span> to put in a reschedule request now!
</span><br/>
