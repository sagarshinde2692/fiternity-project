...
<title>Fitternity Newsletter 2</title>
<style type="text/css">
   ...
   img {max-width:100%; outline:none; text-decoration:none;border:none; -ms-interpolation-mode: bicubic;}
   a img {border:none;}
...
<body>
  <div class="block">
     ...
     <table width="100%" bgcolor="#fff" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header" class="devicewidth" style="table-layout:fixed;">
        <tbody>
           <tr>
              <td align="center"><table width="580" bgcolor="#fff" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" hlitebg="edit" shadow="edit">
                <tbody>
                  <tr>
                    <td><!-- logo -->
                      ...
                      <table width="280" cellpadding="0" cellspacing="0" border="0" align="left" class="devicewidth">
                        <tbody>
                          <tr>
                            <td width="270" height="50" align="left" class="menu" style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #ffffff;line-height: 24px; padding: 10px 0;" st-content="menu"><a href="http://www.fitternity.com/" target="_blank"><div class="imgpop"><img src="http://email.fitternity.com/105/fitternity_transparent.png" alt="" border="0"></div></a></td>
                            <td width="20"></td>
                        </tr>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 18px; padding:5px 5px; color:#666" st-content="fulltext-paragraph">
                                    ...
                                    <p style="padding-top:10px">We wanted to share an update on the FitMania Sale - we have got a great response and expect more sales this week. Here is a summary of the orders received so far - </p>
       ...
       <tr>
          <td align="center">
             <table bgcolor="#f3f3f3" width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" modulebg="edit">
                <tbody>
                    <tr>
                      <td bgcolor="#FFFFFF" height="25" style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color:#666; padding:5px; font-weight:bold;" st-title="3col-title1">
                                          ...
                                          <td>
                                             ...
                                             <table  width="100%" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                                                <tbody>
                                                   ...
                                                   <tr>
                                                      <td width="15%" height="64" style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 20px;  color: #ec8601;" st-title="3col-title1">
                                                       <p style="font-weight:light">Name of the customer:   

                                                       </td>
                                                       <td width="15%" height="64" style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 20px; color: #ec8601;" st-title="3col-title1">
                                                           <p style="font-weight:light">Purchase details</td>
                                                            <td width="15%" height="64" style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 20px; color: #ec8601;" st-title="3col-title1">
                                                               <p style="font-weight:light">Brand</td> 
                                                                   <td width="15%" height="64" style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 20px; color: #ec8601;" st-title="3col-title1">
                                                                       <p style="font-weight:light">Subscription Code   

                                                                       </td> <td width="15%" height="64" style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 20px;  color: #ec8601;" st-title="3col-title1">
                                                                       <p style="font-weight:light">Amount (in Rs.) 

                                                                       </td> <td width="25%" height="64" style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 20px; color: #ec8601;" st-title="3col-title1">
                                                                       <p style="font-weight:light">Contact number of the customer 
                                                                       </tr>
                                                                       ...
                                                                       <tr style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:center;line-height: 20px;  " st-title="3col-title1">
                                                                          ...
                                                                          <td>{{ ucwords($value['order_id']) }}</td> 
                                                                          <td>{{ ucwords($value['amount']) }}</td> 
                                                                          <td>{{ ucwords($value['customer_phone']) }}</td>
                                                                      </tr>
                                                                      @endforeach
                             ...
                             <table bgcolor="#fff" width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" modulebg="edit">
                                <tr>
                                  <td height="25" style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color:#666; padding-left:5px; padding-top:10px;" st-title="3col-title1">
                                    ...
                                    <p style="padding-top:10px">If there are any queries reach out to your respective Relationship Manager or call us on {{Config::get('app.contact_us_vendor_number')}} / email on <a style="text-decoration:none; color:#ec8601" href="mailto:{{Config::get('app.contact_us_vendor_email')}}"> {{Config::get('app.contact_us_vendor_email')}}</a></p>
                ...
                <td align="center"><table width="580" cellspacing="0" cellpadding="15" align="center" class="devicewidth">
                  <tbody>
                    <tr style="background-color:#fff">
                      ...
                      <td align="center" style="color:#666; font-family:Arial, sans serif; font-size:13px;" width="200">Call - {{Config::get('app.contact_us_vendor_number')}}</td>
