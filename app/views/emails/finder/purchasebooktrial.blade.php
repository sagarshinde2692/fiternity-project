            ...
            <tbody>
              ...
              <tr>
                <td style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 18px; padding:5px 5px; color:#666" st-content="fulltext-paragraph">
                  <p style="padding-top:20px">Hi, 
                    <p style="padding-top:20px"> Greetings from Fitternity</p>
                    <p style="padding-top:20px; font-size:15px;">We have processed a membership purchase for {{ ucwords($finder_name) }} @if ($show_location_flag) ,  {{ ucwords($finder_location) }} @endif on Fitternity.com. Here are the details:</p>
                  </td>
                </tr>
                <tr>
      ...
      <td align="center">
       <table bgcolor="#f3f3f3" width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" modulebg="edit">
                     ...
                     <table width="266" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                      ...
                      <tr>
                       ...
                       <tr>
                         ...
                         <tr>
                          <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color: #ec8601;" st-title="3col-title1">
                           <p style="font-weight:light">Email id of the Customer
                           </td>
                         </tr>
                         <tr>
                           <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color: #333; font-weight:500" st-title="3col-title1">
                         ...
                         <tr>
                          <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color: #ec8601;" st-title="3col-title1">
                            <p style="font-weight:light">Starting Time:</p>

                          </td>
                        </tr>
                        <tr>
                         <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color: #333; font-weight: 500" st-title="3col-title1">
                           {{ date(' g\.i A', strtotime($start_date_starttime) ) }}
                         </td>
                       </tr>
                       <?PHP } ?>


                       <?php if(isset($amount_finder) && $amount_finder != ""){ ?> 
                       <tr>
                        <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color: #ec8601;" st-title="3col-title1">
                         <p style="font-weight:light">Amount :   
                         </td>
                       </tr>
                       <tr>
                         <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color: #333; font-weight:500" st-title="3col-title1">
                 ...
                 <table width="266" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                  ...
                  <tr>
                   ...
                   <tr>
                     ...
                     <tr>
                      <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color: #ec8601;" st-title="3col-title1">
                       <p style="font-weight:light">  Membership detail:</p>
                     </td>
                   </tr>

                   <tr>
                     <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color: #333; font-weight:500" st-title="3col-title1">
                       {{ ucwords($service_name_purchase) }}
                     </td>
                   </tr>
                   <?php } ?> 
                   ...
                   <tr>
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color: #ec8601;" st-title="3col-title1">
                     <p style="font-weight:light">  Membership Duration:</p>
                   </td>
                 </tr>

                 <tr>
                   <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color: #333; font-weight:500" st-title="3col-title1">
                     {{ ucwords($service_duration_purchase) }}
                   </td>
                 </tr>
                 <?php } ?> 
        ...
        <?PHP } ?>
                 ...
                 <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color: #ec8601;" st-title="3col-title1">
                   <p style="font-weight:light">  Payment mode:</p>
                 </td>
               </tr>

               <tr>
                 <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 20px; vertical-align:text-top; color: #333; font-weight:500" st-title="3col-title1">
                   {{ ucwords($membership_bought_at) }}
                 </td>
               </tr>
               <?php } ?> 
