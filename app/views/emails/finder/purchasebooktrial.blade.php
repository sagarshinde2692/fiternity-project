                        ...
                        <table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" modulebg="edit">
                                            ...
                                            <tbody>
                                                ...
                                                <tr style="background-color:#f6f6f6;">
                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:left;line-height: 23px; color: #626262; padding:20px;" st-content="fulltext-paragraph">
                                                        ...
                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px; padding-top:10px; " st-content="fulltext-paragraph"> We have processed a membership purchase for {{ ucwords($finder_name) }} @if ($show_location_flag) ,  {{ ucwords($finder_location) }} @endif on Fitternity</p>
                                                </td>
                                            </tr>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 20px; text-align:center;color: #464646;; padding-left:20px; " st-content="fulltext-paragraph">
                                                                        ...
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-weight:bold;font-size: 15px; text-align:left;line-height: 23px; padding-top:10px;" st-content="fulltext-paragraph">Email id of the Customer:</p> 
                                                                        ...
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-weight:bold;font-size: 15px; text-align:left;line-height: 23px; padding-top:10px;" st-content="fulltext-paragraph">Phone Number of the customer:</p> 
                                                                        ...
                                                                        <?php if(isset($start_date_starttime) && $start_date_starttime != ""){ ?> 
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-weight:bold;font-size: 15px; text-align:left;line-height: 23px; padding-top:10px;" st-content="fulltext-paragraph"> Starting Time:</p>
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 18px; " st-content="fulltext-paragraph">{{ date(' g\.i A', strtotime($start_date_starttime) ) }}</p>
                                                                        <?php }?>
                                                            ...
                                                            <tbody>
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <?php if(isset($service_duration_purchase) && $service_duration_purchase != ""){ ?> 
                                                                        ...
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 15px; " st-content="fulltext-paragraph">{{ ucwords($service_duration_purchase)  }}</p>
                                                                        <?php }?>
                                                                        ...
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 15px; " st-content="fulltext-paragraph">{{ ucwords($finder_branch)  }}</p>
                                                                        <?php }?>

                                                                        <?php if(isset($membership_bought_at) && $membership_bought_at != ""){ ?> 
                                                                        ...
                                                                        <p style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 15px; " st-content="fulltext-paragraph">{{ ucwords($membership_bought_at)  }}</p>
                                                                        <?php }?>
                            ...
                            <tr style="background-color:#f6f6f6;">
                                <td style="font-family:Arial, Helvetica, sans-serif; font-size: 15px; text-align:left;line-height: 23px; color: #464646; padding:20px; font-weight:light" st-content="fulltext-paragraph">
                                    <p style="padding-top:10px">You could reach out to the customer directly and take it forward.</p>
                                    <p style="padding-top:10px">If there is any update at our end regarding this customer we shall let you know.</p>
                                    <p style="padding-top:10px">If you have any questions or need any support please reply to this mail or call us on {{Config::get('app.contact_us_vendor_number')}}.</p>
