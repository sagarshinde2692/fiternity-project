		...
		if($delay == null){
            ...
            $messageid = Queue::push(function($job) use ($to, $message){ 
                ...
                foreach ($to as $number) {
                    ...
                    $sms_url = "http://103.16.101.52:8080/bulksms/bulksms?username=vnt-fitternity&password=fitter123&type=0&dlr=1&destination=" . urlencode(trim($number)) . "&source=fitter&message=" . urlencode($msg);
                    $ci = curl_init();
