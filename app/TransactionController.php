...
class TransactionController extends \BaseController {
    ...
    function getPaymentDetails($data,$payment_mode_type){
        ...
        //     Log::info("asdasdad--------=========asdasdasdas");
        //     Log::info($data['convinience_fee']);
        //     $amount_payable['value'] = 'Rs. '.($data['amount_final']+$data['convinience_fee']);
        // }
    ...
    public function verifyAmazonChecksumSignature($website = false){
    	...
    	if($val['isSignatureValid'] == 'true'&&!empty($val["verificationOperationName"])&&$val["verificationOperationName"]=='VERIFY_CHARGE_STATUS'&&isset($val["transactionValue"])){
            ...
            Log::info("Mai jeeta laxansh se");
            Log::info($val);
            Log::info(" info ".print_r(json_encode($val),true));
    ...
    public function verifyAmazonChecksum($website = false){ 
        ...
        Log::info(" info ".print_r($val,true));
...
//             	Log::info(" info order".print_r($order,true));
            ...
            Log::info(" info payment success ".print_r($paymentSuccess,true));
        }
