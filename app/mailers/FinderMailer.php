...
//			'user_name' =>  $user_name,
	...
	public function common($label,$data,$message_data,$delay = 0){
		...
		if(!Config::get('app.vendor_communication')){
			...
			$message_data['user_email'] = array('sailismart@fitternity.com', 'dhruvsarawagi@fitternity.com', 'akhilkulkarni@fitternity.com', 'ankitamamnia@gmail.com', 'rohitvarade@fitternity.com');
		}
