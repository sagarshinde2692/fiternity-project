	...
	public function home($city = 'mumbai',$cache = true){
		...
		if(isset($_GET['device_type']) && (strtolower($_GET['device_type']) == "android")){
			...
			if(isset($_GET['device_type']) && (strtolower($_GET['device_type']) == "ios") && isset($_GET['app_version']) && ((float)$_GET['app_version'] <= 4.1)){
				...
				$cat['pune'] = array("gyms","yoga","zumba","fitness-studios",/*"crossfit",*/"pilates"/*,"healthy-tiffins"*/,"cross-functional-training","mma-and-kick-boxing","dance","spinning-and-indoor-cycling","luxury-hotels"/*,"sport-nutrition-supliment-stores"*/,"aerobics"/*,"kids-fitness"*/,"pre-natal-classes","aerial-fitness"/*,"personal-trainers"*/);
				...
				$cat['delhi'] = array("gyms","yoga","zumba","fitness-studios",/*"crossfit",*/"pilates"/*,"healthy-tiffins"*/,"cross-functional-training","mma-and-kick-boxing","dance","spinning-and-indoor-cycling","luxury-hotels"/*,"sport-nutrition-supliment-stores"*/,"kids-fitness","pre-natal-classes","aerial-fitness"/*,"personal-trainers"*/);
		...
		if(isset($_REQUEST['device_type']) && in_array($_REQUEST['device_type'],['ios','android']) && isset($_REQUEST['app_version']) && ((float)$_GET['app_version'] >= 4.4)){
			...
			// 		'title'=>'Coupon Discount End of Jan Sale',
			// 		'height'=>100,
			// 		'width'=>375,
			// 		'ratio'=>(float) number_format(100/375,2)
			// 	];
			...
			// 	$result['campaigns'][] = [
			// 		'image'=>'https://b.fitn.in/global/Homepage-branding-2018/fitnesssale-appbanner.png',
			// 		'link'=>'https://www.fitternity.com/sale?mobile_app=android',
			// 		'title'=>'Coupon Discount End of Jan Sale',
			// 		'height'=>100,
			// 		'width'=>375,
			// 		'ratio'=>(float) number_format(100/375,2)
