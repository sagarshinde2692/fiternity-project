                            ...
                            if($rewards_value['reward_type'] == "fitness_kit" || $rewards_value['reward_type'] == "healthy_snacks"){
                                switch(true){
                                    ...
                                    case (5000 < $amount && $amount < 7500) :
                                        ...
                                        $rewards_value['contents'] =  $rewards_value['reward_type'] == "fitness_kit"  ? ["Shaker", "Earphone Detangler"] : ["Pop Mak – Roasted Flavoured Makhana 50gm", "2 Honey Chew Pouch (5 flavours) 40gm", "3 Vegan Protein Bar 1 piece", "4 Jalapeno Peanuts 75gm", "5 Wholewheat Thins 100gm", "6 Seedy Crunchers 80gm", "7 Chocolate Chip Waffle 1 piece", "8 Okra & Sweet Potato Chips (Sea Salt) 30gm", "9 Rostaa – Healthy Mix 35gm"];
                                        break;
                                    case (7500 < $amount && $amount < 10000) :
                                        $rewards_value['payload']['amount'] = $rewards_value['reward_type'] == "fitness_kit" ? 3000 : 2150;
                                        $rewards_value['contents'] = $rewards_value['reward_type'] == "fitness_kit"  ? ["T-shirt", "Gym bag", "Shaker", "Earphone Detangler", "Mug", "Skipping Details"] : ["Pop Mak – Roasted Flavoured Makhana 50gm", "2 Honey Chew Pouch (5 flavours) 40gm", "3 Vegan Protein Bar 2 piece", "4 Baked Bhakarwadi 85gm", "5 Wholewheat Thins 200gm", "6 Jackfruit Chips 30gm", "7 French & Vanilla Granola Crunchers 200gm", "8 Okra & Sweet Potato Chips (Sea Salt) 30gm", "9 Rostaa – Trail Mix 35gm", "10 Rostaa – Mix Berries 75gm", "11 Stroopwaffle (Caramel Wafer Biscuits/ Cookies) 1 piece"];
                                        break;
                                    case (10000 < $amount && $amount < 15000) :
                                        $rewards_value['payload']['amount'] = $rewards_value['reward_type'] == "fitness_kit" ? 4000 : 3150;
                                        $rewards_value['contents'] = $rewards_value['reward_type'] == "fitness_kit"  ? ["T-shirt", "Gym bag", "Shaker", "Earphone Detangler", "Mug", "Resistance Band", "Coaster", "Notebook"] : ["Pop Mak – Roasted Flavoured Makhana 50gm", "2 Honey Chew Pouch (5 flavours) 40gm", "3 Vegan Protein Bar 2 piece", "4 Baked Bhakarwadi 85gm", "5 Wholewheat Thins 200gm", "6 Jackfruit Chips 30gm", "7 French & Vanilla Granola Crunchers 200gm", "8 Okra & Sweet Potato Chips (Sea Salt) 30gm", "9 Rostaa – Trail Mix 35gm", "10 Rostaa – Mix Berries 75gm", "11 Stroopwaffle (Caramel Wafer Biscuits/ Cookies) 1 piece"];
                                        break;
