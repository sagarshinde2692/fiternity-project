                            ...
                            if($rewards_value['reward_type'] == "fitness_kit" || $rewards_value['reward_type'] == "healthy_snacks"){
                                switch(true){
                                    ...
                                    case (25000 <= $amount && $amount < 30000) :
                                        ...
                                        $rewards_value['image'] =  $rewards_value['reward_type'] == "fitness_kit" ? "https://b.fitn.in/gamification/reward/goodies/kit-8-1-6-2017.jpg" : "https://b.fitn.in/gamification/reward/goodies/hamper-2.jpg";
                                        break;
                                    case (30000 <= $amount) :
