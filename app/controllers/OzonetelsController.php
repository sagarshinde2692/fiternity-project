	    		...
	    		if(isset($_REQUEST['fit_action']) && $_REQUEST['fit_action'] == 'select_extension'){
		    		...
		    		if($extension < 1 || $extension > 99){
				    	...
				    	if($ozonetelNoDetails){
				    		...
				    		if($this->jump_start_time < $this->current_date_time && $this->current_date_time < $this->jump_end_time && in_array($this->sunday,["Sunday","Friday"]) && in_array($ozonetelNoDetails->finder->_id, $this->direct_route_to_fitternity_vendor)){
