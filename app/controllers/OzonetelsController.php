	    		...
	    		if(isset($_REQUEST['fit_action']) && $_REQUEST['fit_action'] == 'select_extension'){
		    		...
		    		if($extension < 1 || $extension > 99){
				    	...
				    	if($ozonetelNoDetails){
				    		...
				    		if($this->jump_start_time < $this->current_date_time && $this->current_date_time < $this->jump_end_time && !in_array($this->sunday,["Sunday","Monday"]) && (in_array($ozonetelNoDetails->finder->_id, $this->direct_route_to_fitternity_vendor) /*|| $finder_count > 0*/)){
							...
							}elseif($this->jump_start_time < $this->current_date_time && $this->current_date_time < $this->jump_end_time && !in_array($this->sunday,["Sunday","Monday"]) && ( in_array($ozonetelNoDetails->finder->_id, $this->jump_finder_ids) || in_array($ozonetelNoDetails->finder->city_id, [4,8,9]))){
		...
		if (isset($_REQUEST['event']) && $_REQUEST['event'] == 'NewCall') {
			...
			if($ozonetelNoDetails){
                ...
                //if(in_array($ozonetelNoDetails->finder->city_id, $city) || in_array($ozonetelNoDetails->finder->_id, $this->jump_finder_ids)) {
                	...
                	if($this->jump_start_time < $this->current_date_time && $this->current_date_time < $this->jump_end_time && !in_array($this->sunday,["Sunday","Monday"]) && in_array($ozonetelNoDetails->finder->_id, $this->jump_finder_ids)){
