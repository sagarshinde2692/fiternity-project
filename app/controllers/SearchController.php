...
class SearchController extends \BaseController {
	...
	public function getFindersv3(){
		...
		$location 			=	(Input::json()->get('regions')) ? strtolower(Input::json()->get('regions')) : '';		
		...
		$location_filter 		= ($location != '') ? '{"terms" : {  "location": ["'.str_ireplace(',', '","',strtolower(Input::json()->get('regions'))).'"] }},'  : '';	
		$locationtags_filter 	= ($location != '') ? '{"terms" : {  "locationtags": ["'.str_ireplace(',', '","',strtolower(Input::json()->get('regions'))).'"] }},'  : '';	
	...
	public function getFitmaniaFinders(){
		...
		$resp = array(
			...
			"deals_today_communication" => "Valentine's Day Special", 
			"deals_tomorrow_communication" => "Valentine's Day Special", 
			"deals_coming_communication" => "Golds Gym & More....", 
