...
class TransactionController extends \BaseController {
    ...
    public function testMail(){
        Log::info('test mail');
        $redisid = Queue::connection('sync')->push('TransactionController@sendCommunication', array('order_id'=> '157252'),Config::get('app.queue'));
    }
    ...
    public  function sendCommunication($job,$data){
        ...
        try {
            ...
            if($order['status'] == '0' && $order['payment_mode'] == 'paymentgateway'){
