        ...
        if(isset($old_order_id)){
            ...
            if($order){
               $order->update($data); 
                ...
                $order->_id = $order_id;
                $order->save();
                $redisid = Queue::connection('redis')->push('TransactionController@updateRatecardSlots', array('order_id'=>$order_id, 'delay'=>date('d-m-Y H:i:s',strtotime('+10 minutes'))),Config::get('app.queue'));
            }
