...
class TransactionController extends \BaseController {
    ...
    public function capture($data = null){
        ...
        if(!empty($ratecardDetail) && !empty($finderDetail)){
            ...
            if($data['type']=='memberships' && !empty($data['batch']) && (count($data['batch'])>0) && $studioExtValidity && !empty($ratecardDetail['data']['duration']) && count($ratecardDetail['data']['duration'])>0 && !empty($ratecardDetail['data']['sessions']) && count($ratecardDetail['data']['sessions'])>0 && (empty($finderDetail['data']['finder_flags']['trial']) || $finderDetail['data']['finder_flags']['trial']=='auto')){
