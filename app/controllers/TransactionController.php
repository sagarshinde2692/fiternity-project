    ...
    public function successCommon($data){
        ...
        if($data['status'] == 'success' && $hash_verified){
            ...
            if($order['type'] == 'memberships' || $order['type'] == 'healthytiffinmembership'){
                ...
                if(!(!empty($order->duration_day) && $order->duration_day == 30  && !(!empty($data["order_success_flag"]) && $data["order_success_flag"] == "admin"))&& !(!empty($data["order_success_flag"]) && $data["order_success_flag"] == "admin"))){
