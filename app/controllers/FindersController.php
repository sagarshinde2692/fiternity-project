	...
	public function addPPSStripeData($ratecard, $service_slug, $finder_slug){
		...
		$return['pps_details'] =[
			...
			'description'=>[
				...
				'data'=>[
					['image'=>'https://b.fitn.in/paypersession/pps_stripe1.png', 'text'=>'New to fitness and want to figure what’s best?'],
					['image'=>'https://b.fitn.in/paypersession/pps_stripe2.png', 'text'=>'Wish to do a variety of different workouts?'],
					['image'=>'https://b.fitn.in/paypersession/pps_stripe3.png', 'text'=>'Not sure if you will workout everyday?']
				],
			],
		];
		...
		$return['pps_details']['more_info'] = [
			...
			'description'=>"Step 1: Choose your workout form out of 17 different options\n\nStep 2: Book session of your choice near you with instant booking\n\nStep3: Enjoy your workout and repeat",
		];
