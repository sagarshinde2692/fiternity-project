    ...
    public function getSuccessMsg($type, $id){
        ...
        if($type != "" && $id != ""){
            ...
            if (in_array($type, $booktrialItemArr)){
                ...
                $itemData       =   Booktrial::customerValidation(customerIdFromToken())->find(intval($id));
            ...
            if (in_array($type, $orderItemArr)) {
                ...
                $itemData = Order::customerValidation(customerIdFromToken())->find(intval($id));
            ...
            if(in_array($type, ["booktrial","workoutsession","workout-session","booktrials"])){
                ...
                if(isset($item['booktrial_id']) && $item['booktrial_id'] != ""){
                    ...
                    $order_booktrial = Booktrial::customerValidation(customerIdFromToken())->find(intval($item['booktrial_id']));
