...
class EmailSmsApiController extends \BaseController {
	...
	public function sendSMS($smsdata){
		...
		$live_url = "http://103.16.101.52:8080/bulksms/bulksms?username=vnt-fitternity&password=fitter123&type=0&dlr=1&destination=" . urlencode($to) . "&source=fitter&message=" . urlencode($message);
		$ch = curl_init();
