    ...
    public function sendCommunication($job,$data){
        ...
        try{
            ...
            if($currentScheduleDateDiffMin >= (60 * 12)){
                ...
                $delayReminderTimeBefore6Hour      =    \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', date('Y-m-d H:i:s',strtotime($booktrial->schedule_date_time)))->subMinutes(60 * 12);
            ...
            if($currentScheduleDateDiffMin >= (60 * 3)){
                ...
                $delayReminderTimeBefore6Hour      =    \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', date('Y-m-d H:i:s',strtotime($booktrial->schedule_date_time)))->subMinutes(60 * 3);
