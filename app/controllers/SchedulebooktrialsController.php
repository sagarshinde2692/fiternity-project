    ...
    public function sendCommunication($job,$data){
        ...
        try{
            ...
            if($currentScheduleDateDiffMin >= (60 * 12)){
                ...
                $delayReminderTimeBefore6Hour      =    \Carbon\Carbon::createFromFormat('d-m-Y g:i A', $booktrial->schedule_date_time)->subMinutes(60 * 12);
            ...
            if($currentScheduleDateDiffMin >= (60 * 6)){
                ...
                $delayReminderTimeBefore6Hour      =    \Carbon\Carbon::createFromFormat('d-m-Y g:i A', $booktrial->schedule_date_time)->subMinutes(60 * 6);
            ...
            if($currentScheduleDateDiffMin >= (60 * 3)){
                ...
                $delayReminderTimeBefore6Hour      =    \Carbon\Carbon::createFromFormat('d-m-Y g:i A', $booktrial->schedule_date_time)->subMinutes(60 * 3);
            ...
            if($currentScheduleDateDiffMin >= (20)){
                ...
                $delayReminderTimeBefore20Min      =    \Carbon\Carbon::createFromFormat('d-m-Y g:i A', $booktrial->schedule_date_time)->subMinutes(20);
            ...
            $delayReminderTimeAfter90Min      =    \Carbon\Carbon::createFromFormat('d-m-Y g:i A', $booktrial->schedule_date_time)->addMinutes(90);
